...
# class_names = ["slope"]
class_names = ["green_go", "red_stop", "speed_limited", "speed_limited_min", "speed_unlimited", "yellow_back", "zebra_stripes"]
class_thres = [0.5, 0.5, 0.9, 0.9, 0.9, 0.9, 0.9, 0.3, 0.5]
